...
/** Sidebar brand subtitle under the product name. */
export const APP_PRODUCT_TAGLINE = 'Smarter Fleet. Stronger Business.';
...
export const APP_LOGIN_LOGO_PATH = '/brand/sheikhgo-logo-login-v8.png';
