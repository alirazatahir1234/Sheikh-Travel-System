...
class _TimelineTile extends StatelessWidget {
  ...
  static const _iconMap = <String, IconData>{
    ...
    'trip': Icons.alt_route,
    'payment': Icons.payments_outlined,
    'paymentcollected': Icons.payments_outlined,
    'arrived': Icons.place_outlined,
    'onboard': Icons.airline_seat_recline_normal,
  ...
  static const _colorMap = <String, Color>{
    ...
    'trip': AppColors.primary,
    'payment': AppColors.success,
    'paymentcollected': AppColors.success,
    'arrived': AppColors.info,
    'onboard': AppColors.primaryLight,
