...
using SheikhTravelSystem.Infrastructure.Persistence.Repositories;
...
public static class DependencyInjection
{
    public static IServiceCollection AddInfrastructure(this IServiceCollection services, IConfiguration configuration)
    {
        ...
        services.AddScoped<IGpsAlertWriter, SheikhTravelSystem.Infrastructure.Services.Gps.GpsAlertWriter>();
        services.AddScoped<IGpsPositionIngestionHelper, SheikhTravelSystem.Infrastructure.Services.Gps.GpsPositionIngestionHelper>();
        ...
        services.AddScoped<IMaintenanceModuleRepository, MaintenanceModuleRepository>();
        ...
        services.AddScoped<IGpsDeviceAuthService, GpsDeviceAuthService>();
        services.AddScoped<IDevDataService, DevDataService>();
        services.AddScoped<IDriverRepository, DriverRepository>();
        services.AddScoped<IDriverAppRepository, DriverAppRepository>();
        services.AddScoped<IDriverAllowanceRepository, DriverAllowanceRepository>();
        services.AddScoped<ICustomerPortalRepository, CustomerPortalRepository>();
        services.AddScoped<IPortalPricingService, PortalPricingService>();
