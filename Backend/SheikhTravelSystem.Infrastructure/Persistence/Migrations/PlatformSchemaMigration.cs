...
public static class PlatformSchemaMigration
{
    ...
    private static async Task SeedPermissionsAsync(System.Data.IDbConnection connection, CancellationToken ct)
    {
        var permissions = new (string Module, string Code, string Desc)[]
        {
            ...
            ("Fleet", "Driver.Create", "Create drivers"),
            ("Fleet", "Driver.Update", "Update drivers"),
            ...
            ("Fleet", "Gps.CommandPositionRequest", "Request an on-demand GPS position"),
            ("Fleet", "Gps.CommandRestart", "Restart a GPS device remotely"),
            ("Fleet", "Gps.CommandRelay", "Toggle relay/digital output commands"),
            ("Fleet", "Gps.CommandBuzzer", "Send buzzer commands"),
            ("Fleet", "Gps.CommandCustomSms", "Queue a custom SMS command (delivery not yet wired to a carrier)"),
            ("Fleet", "Gps.CommandRetry", "Retry a failed GPS command"),
            ("Fleet", "Gps.CommandCancel", "Cancel a pending GPS command"),
            ("Fleet", "Fuel.View", "View fuel logs"),
            ("Fleet", "Maintenance.View", "View maintenance"),
            ("Fleet", "Maintenance.Manage", "Create and manage maintenance schedules and records"),
            ("Fleet", "Maintenance.Request.Create", "Create maintenance service requests"),
            ("Fleet", "Maintenance.Request.Approve", "Approve or reject maintenance service requests"),
            ("Fleet", "Maintenance.WorkOrder.Manage", "Manage maintenance work orders"),
            ("Fleet", "Maintenance.Workshop.Manage", "Manage workshops"),
            ("Fleet", "Maintenance.Vendor.Manage", "Manage vendors"),
            ("Fleet", "Maintenance.Report.View", "View and export maintenance reports"),
