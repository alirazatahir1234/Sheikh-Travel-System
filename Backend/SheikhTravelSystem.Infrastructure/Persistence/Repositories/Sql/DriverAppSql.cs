...
public static class DriverAppSql
{
    /// <summary>
    ...
    /// </summary>
    public const string CurrentVehicleApply = """
        OUTER APPLY (
    ...
    public const string AssignedVehicleIdsUnion = """
    ...
    public const string DriverOwnsVehicleExists = """
